...
function upiwc_rating_admin_notice() {
    ...
    <div class="notice notice-success">
        <p><?php _e( 'Hey, I noticed you\'ve been using UPI QR Code Payment for WooCommerce for more than 1 week – that’s awesome! Could you please do me a BIG favor and give it a <strong>5-star</strong> rating on WordPress? Just to help me spread the word and boost my motivation.', 'upi-qr-code-payment-for-woocommerce' ); ?></p>
...
function upiwc_dismiss_rating_admin_notice() {
    if( get_option( 'upiwc_plugin_no_thanks_rating_notice' ) === '1' ) {
        if ( get_option( 'upiwc_plugin_dismissed_time' ) > strtotime( '-168 hours' ) ) {
            return;
        }
