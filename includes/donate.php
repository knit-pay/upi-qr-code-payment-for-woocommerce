...
function upiwc_donate_admin_notice() {
    ...
    <div class="notice notice-success">
        <p><?php _e( 'Hey, I noticed you\'ve been using UPI QR Code Payment Gateway for more than 2 week – that’s awesome! If you like UPI QR Code Payment Gateway and you are satisfied with the plugin, isn’t that worth a coffee or two? Please consider donating. Donations help me to continue support and development of this free plugin! Thank you very much!', 'upi-qr-code-payment-for-woocommerce' ); ?></p>
        <p><a href="https://rzp.io/l/Bq3W5pr" target="_blank" class="button button-secondary"><?php _e( 'Donate Now', 'upi-qr-code-payment-for-woocommerce' ); ?></a>&nbsp;
